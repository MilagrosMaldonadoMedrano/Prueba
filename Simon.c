...
void simon8(SDL_Renderer* renderer,const int simon[][60])
{
    ...
    notas[4] = sonido_carga("snd/sol.mp3");
    notas[5] = sonido_carga("snd/la.mp3");
    notas[6] = sonido_carga("snd/sol.mp3");
    notas[7] = sonido_carga("snd/la.mp3");
    ...
    {
        SDL_Delay(150);
        dibujar(renderer,simon,60,60,inicioX,inicioY);
        ...
        if(acierto)
        {
            ...
            //genero la nueva luz
            contador++;
            vectorInsertarAlFinal(&vDetecciones,rand()%8);
        }
    }
...
/*
void simon3(SDL_Renderer* renderer,const int simon[][60])
{
    if (!sonido_ini())
    {
        return;
    ...
    while(ejecutando)
    {
        ...
        if(acierto)
        {
            ...
            //genero la nueva luz
            contador++;
            vectorInsertarAlFinal(&vDetecciones,rand()%3);
        }
    }
